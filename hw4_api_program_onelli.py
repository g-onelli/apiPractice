...
number of commits."""
    ...
    while key_number<len(repo_dict):
        print(commit_dict[key_number])
        print("Repository "+repo_dict[key_number]+" has "+commit_dict[key_number]+" commits")
...
#    print("answer five")
    combine_repo_and_commits(ans_two,ans_five)
